...
def send_summary(message):
    ...
    if selected_campaign_id in unique_campaign:
        ...
        total_spent = df_campaign['spent'].sum().astype('int32')
        total_conversion = df_campaign['total_conversion'].sum().astype('int32')
...
def send_plot(message):
    ...
    if selected_campaign_id in unique_campaign:
        ...
        df_campaign = df[(df['campaign_id']==selected_campaign_id)]
        df_plot = df_campaign[['spent','approved_conversion','age']].groupby(['age']).sum()
